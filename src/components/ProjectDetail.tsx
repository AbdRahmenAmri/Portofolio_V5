...
const handleExternalLinkClick = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>, link: string | undefined) => {
  e.preventDefault()
  if (link) return true;
  Swal.fire({
    icon: 'info',
    title: 'Private Link',
    text: 'Sorry, the link is private.',
...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    selectedProject && setProject(selectedProject)
  }, [id]);
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16">
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <ProjectStats features={project.features} technologies={project.technologies} />
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                <a
                  ...
                  onClick={(e) => handleExternalLinkClick(e, project.repo)}
                >
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInRight">
              ...
              <div className="bg-white/[0.02] backdrop-blur-xl rounded-2xl p-8 border border-white/10 space-y-6 hover:border-white/20 transition-colors duration-300 group">
                ...
                <FeatureItems features={project.features} />
              </div>
            </div>
          </div>
        </div>
